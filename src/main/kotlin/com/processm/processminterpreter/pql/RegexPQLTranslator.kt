...
/**
 * Regex-based PQL to Cypher translator
 *
 * This is the legacy implementation using regular expressions for parsing.
 * Kept for backward compatibility and as fallback option.
 * The new ANTLR-based parser (AntlrPQLTranslator) is recommended for production use.
 */
@Component
@ConditionalOnProperty(name = ["pql.parser.type"], havingValue = "regex")
class RegexPQLTranslator : PQLTranslator {

    private val logger = LoggerFactory.getLogger(RegexPQLTranslator::class.java)
